...
HD_PWD='/home/lic9/prj/MCUCANDRIVER/vivadoCanDriverTest/vivadoCanDriverTest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log can_split_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source can_split_wrapper.tcl
