...
#
# Script generated by Vivado on Thu Jan 04 19:14:33 GMT 2024
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : can_split.sh
...
#
# Usage        : can_split.sh
#                can_split.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                can_split.sh [-reset_run]
#                can_split.sh [-reset_log]
#                can_split.sh [-help]
#
...
#                script (type 'can_split.sh -help' for more information).
#
...
# script info
echo -e "can_split.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./can_split.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.can_split xil_defaultlib.glbl -o can_split_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./can_split_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/lic9/prj/MCUCANDRIVER/vivadoCanDriverTest/vivadoCanDriverTest.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key can_split_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc can_split_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./can_split.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: can_split.sh [-help]\n\
Usage: can_split.sh [-step]\n\
Usage: can_split.sh [-lib_map_path]\n\
Usage: can_split.sh [-reset_run]\n\
Usage: can_split.sh [-reset_log]\n\
Usage: can_split.sh [-keep_index]\n\
Usage: can_split.sh [-noclean_files]\n\n\
